...
## Comando 1
rse[1:2, ]
# Explicación: Se toman solo los dos primeros genes, y todas las columnas se consideran

## Comando 2
rse[, c("A", "D", "F")]

# Explicación: Se toman algunas columnas (A, D, F), y todos los genes se consideran
...
# Ejercicio
## Explora en con un heatmap la expresión de los genes MOBP, MBP y PCP4.

## Si hacemos un clustering (agrupamos los genes), ¿cúales genes se parecen más?
  # Los genes que más se parecen son MBP y MOBP.

##  ¿En qué capas se expresan más los genes MOBP y MBP?
  # La capa donde más se expresan es la de materia blanca.
